...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Category car1 = new Category(null, "Electronics");
		Category car2 = new Category(null, "Books");
		Category car3 = new Category(null, "Computers");
		
		categoryRepository.saveAll(Arrays.asList(car1, car2, car3));
